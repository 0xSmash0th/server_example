...
$tag = 'item_combat';
$ignores = [];
$colstr = "id	name	image	line_up	force	type	target	target_format_text	hitarea	hitarea_format_text	weapon	min_damage	max_damage	damage_format_text	eff1_id	eff1_level	eff1_target	eff1_format_text	eff2_id	eff2_level	eff2_target	eff2_format_text	req	time	cost_gold	cost_honor	cost_star	sell_gold	limit_product	limit_owned	limit_overlap";
